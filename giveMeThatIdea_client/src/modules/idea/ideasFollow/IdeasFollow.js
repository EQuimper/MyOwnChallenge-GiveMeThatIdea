...
import { FollowCommentsMeta } from '../feed/components';

const checkIfFollow = (arr, id) => {
  console.log({ arr, id });
  arr.includes(id);
}
...
const IdeasFollow = ({ ideas, ideasFollow, unfollowIdea, followIdea }) => (
